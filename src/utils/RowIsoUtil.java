...
public interface RowIsoUtil {
    ...
    //ValuePermutation
    void applyRowValuePermutation(Grid grid, Cell anchor, int[] image); int[] getRowValuePermutationImage(Grid grid1, Grid grid2, Cell anchor); // Achtung: Diese Methode ist neu! (2018 05 03)

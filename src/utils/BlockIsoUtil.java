...
public interface BlockIsoUtil {
    ...
    //ValuePermutation
    void applyBlockValuePermutation(Grid grid, Cell anchor, int[] image); int[] getBlockValuePermutationImage(Grid grid1, Grid grid2, Cell anchor); // Achtung: Diese Methode ist neu! (2018 05 03)
